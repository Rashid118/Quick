...
try:
	proxy= requests.get('https://github.com/Rashid118/Hacker/blob/main/Hacking.txt').text
...
[-] Brother :    Aijaz_Kashif_Rashid _Asif Ali
[-] TEAM :    ALTAF HUSSAIN__WAHID BUX 
╰──────────•◈•─────────----------──────────╯  
----------------------------------------------
ﮩ٨ـﮩﮩ٨ـ♡ﮩ٨ـﮩﮩ٨ـ☹. LAGHARI KING IS BACK  ﮩ٨ـﮩﮩ٨ـ♡ﮩ٨ـﮩﮩ٨ـ☹.
\033[1;36m----------------------------------------------""")
def linex():
        print('\033[1;33m----------------------------------------------')
def clear():
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        tks = ("Hello Arshad Sir, I Need To Buy Your Paid Arshad PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+'fkeyx')
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python join.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def rndm(ids,passlist):
    ...
    # 'cookie': 'datr=sOBIZZfvzAfo5gEMwUeKB-1W; sb=sOBIZcCDZy57uThsjRC-83Pp',
    'dpr': '2',
